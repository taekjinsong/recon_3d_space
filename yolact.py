...
class Yolact(nn.Module):
    ...
    def __init__(self):
        ...
        elif cfg.mask_type == mask_type.lincomb:        # cfg.mask_type = 1 = mask_type.lincomb
        ...
        if cfg.fpn is not None:
            ...
            self.selected_layers = list(range(len(self.selected_layers) + cfg.fpn.num_downsample)) # [0, 1, 2, 3, 4]
